   ...
   <div>
    ...
    <div class="food">
        ...
        <Row justify="start" style="width: 100%;">
            ...
            <div class="input upload1" >
                <Cascader :data="RoomData" v-model="ROOM" :load-data="loadRoomData" style="width: 100%;" placeholder="楼栋/楼层/房间"/>
            </div>
            </Col>
            </Row>
    </div>
    ...
    <div class="contract">
     ...
     <p class="carePub">
        ...
        <Button type="primary" @click="handleSubmit" style="width: 50%;">保存</Button>
    </div>
   </div>
</template>

<script setup lang='ts'>
import { careInfo,foodInfo,
    bedInfo,contractInfo } from "../data"

<template>
    <div style="width: 100%;">
        <p v-if="props.DeviceInfoListInfo.d1 && props.DeviceInfoListInfo.d4">睡着时的呼吸频率介于{{Math.min(...props.DeviceInfoListInfo.d4)}}到{{ Math.max(...props.DeviceInfoListInfo.d1) }}次/分。</p>
